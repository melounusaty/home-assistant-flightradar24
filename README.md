...
This is a fork of the original [Flightradar24 integration](https://github.com/AlexandrErohin/home-assistant-flightradar24) by [AlexandrErohin](https://github.com/AlexandrErohin), extended with request‑throttling and caching to reduce the amnount of request and mitigate potential 429 (too many requests) API errors.
